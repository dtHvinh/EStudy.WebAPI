...
[Obsolete("This endpoint is deprecated", true)]
public class EndpointV1(ApplicationDbContext context) : Endpoint<GetCardInSetRequest, PagedResponse<FlashCardResponse>>
{
    ...
    public override async Task HandleAsync(GetCardInSetRequest req, CancellationToken ct)
    {
        ...
        if (!string.IsNullOrEmpty(searchTerm))
            query = query.Where(e => e.SearchVector.Matches(searchTerm));
